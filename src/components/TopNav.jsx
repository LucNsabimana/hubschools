    ...
    <div>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ width: 30, height: 30, background: 'var(--orange)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 15, color: 'white' }}>◎</div>
          <div>
            <div style={{ color: 'white', fontSize: 13, fontWeight: 500, lineHeight: 1.3 }}>Boston Community Hub Schools</div>
            <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: 11 }}>Assets & Opportunity Assessment Platform</div>
          </div>
        </div>
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              {user?.picture ? (
                ...
                <div style={{ width: 24, height: 24, borderRadius: '50%', background: 'var(--orange)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 500 }}>
            ...
            {showMenu && (
              <div style={{
                ...
                boxShadow: 'var(--shadow-md)', minWidth: 190, zIndex: 200, overflow: 'hidden',
              }}>
                <div style={{ padding: '11px 14px', borderBottom: '0.5px solid var(--border)' }}>
                ...
                <button onClick={() => { setShowMenu(false); logout(); }} style={{ width: '100%', padding: '10px 14px', textAlign: 'left', background: 'none', fontSize: 13, color: 'var(--red-light)', cursor: 'pointer', display: 'block' }}>
                  Sign out
                </button>
              </div>
            )}
      ...
      <div style={{ background: 'var(--navy-light)', display: 'flex', padding: '0 20px', overflowX: 'auto', position: 'sticky', top: 52, zIndex: 99 }}>
        {visibleTabs.map(tab => (
